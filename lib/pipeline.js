...
(function() {
  var Context, DEBUG, Pipeline, Scope, accessor, async, at, builtins, descendObj, doCmd, fs, inspect, mapInto, parsePipelines, parser, recv_, runPipeline, runPipelines, splitArgs, through, util, _, _inspect,
  ...
  Scope = (function() {
    ...
    Scope.prototype.get = function(t, k) {
      ...
      if (k != null) {
        got = (_ref = this[t]) != null ? _ref[k] : void 0;
      }
      if (k == null) {
        got = this[t];
      }
      return got || ((_ref1 = this.parent) != null ? _ref1.get(t, k) : void 0);
    };
  ...
  descendObj = function(_obj, _expr, ctx, final_cb) {
    var cb, expr, map_get, obj, set, step, tasks, _fn, _i, _len, _ref;
    if (_obj == null) {
    ...
    if (step.map != null) {
      ...
      return async.parallel(tasks, function(err, results) {
        var result, result_obj, _j, _len1;
        result_obj = {};
  ...
  through = function(cmd) {
    return function(inp, args, ctx, cb) {
      ...
      if (pipeline[0].cmd != null) {
        (_ref = pipeline[0].cmd).push.apply(_ref, args);
      }
