...
exports.slugify = exports.words = exports.keywords = exports.strip_html_cmd = void 0;
const helpers_1 = require("../helpers");
const stopwords = new RegExp("\\b" +
...
exports.strip_html_cmd = (0, helpers_1.command)((inp) => strip_html(inp));
// "text" -> keywords -> ["keyword"]
exports.keywords = (0, helpers_1.command)((inp) => strip_html(inp.toLowerCase())
    .replace(stopwords, "")
    .replace(/\s+/, " ")
    .match(/[a-z']{2,}/g));
// "text" -> words -> ["word"]
exports.words = (0, helpers_1.command)((inp) => inp.match(/[\w']{2,}/g));
// "text" -> slugify -> "slug"
exports.slugify = (0, helpers_1.command)((inp) => inp
    .toLowerCase()
    .replace(/\W+/g, "-")
    .replace(/^\W?(.+)\W$/, "$1"));
