...
function inspectValue(value, seen) {
    ...
    const entries = Object.entries(value).map(([k, v]) => k + ": " + inspectValue(v, seen));
    return entries.length ? "{ " + entries.join(", ") + " }" : "{}";
}
exports.inspect = Object.assign((value, _options) => inspectValue(value, new Set()), { custom });
exports.default = { inspect: exports.inspect };
